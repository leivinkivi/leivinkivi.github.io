...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f33c7d82dcd64960160ebac43bcecf3ac0aad6435c439cf320deb8e722984fb7.js',function(){input.required=false;search();});}
