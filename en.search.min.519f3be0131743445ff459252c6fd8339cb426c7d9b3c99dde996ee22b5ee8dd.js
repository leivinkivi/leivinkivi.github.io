...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a0e9d23c4460aa35024ae1a4d1253e3844f4e240766eedfbe87edf8d14ab6b50.js',function(){input.required=false;search();});}
