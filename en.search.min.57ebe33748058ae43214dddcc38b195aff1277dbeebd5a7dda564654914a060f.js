...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e74ffbe6f8e5bfafe17902352c9ba7b1732504517c2a03f98c734d7fdee04fa5.js',function(){input.required=false;search();});}
