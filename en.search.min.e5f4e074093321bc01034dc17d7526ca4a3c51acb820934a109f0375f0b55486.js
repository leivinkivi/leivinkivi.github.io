...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8493cafead21a1e08b9cd94f05a650eb93bf7db609d9f19efe3dff5932c7aae7.js',function(){input.required=false;search();});}
