...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ea111ebbeef6d81c8428551d169e56a5cea474fdbbbeb732ef11a6ad71bcb62f.js',function(){input.required=false;search();});}
