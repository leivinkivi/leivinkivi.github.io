...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c0cfe81e8fb6753a2ac31fbc77b6aa44fe466871e35094882ecff81be88628d7.js',function(){input.required=false;search();});}
