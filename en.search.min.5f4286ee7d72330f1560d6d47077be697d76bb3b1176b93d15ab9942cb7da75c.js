...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5b7cba90a9ffe861f36dadc9a081ce97167996ff1863bf6142a50ce570aa5280.js',function(){input.required=false;search();});}
