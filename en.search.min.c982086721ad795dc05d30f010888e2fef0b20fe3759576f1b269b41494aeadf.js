...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5b6870d8da0796a970dcf385d7ab74c6a05601a6f8c372115789890b32808db4.js',function(){input.required=false;search();});}
