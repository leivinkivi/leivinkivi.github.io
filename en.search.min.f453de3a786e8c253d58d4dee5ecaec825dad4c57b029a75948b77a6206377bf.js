...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.49f04a6d575071968536513525f3ed9366f19a7bf28d3fba92504d560f5066fd.js',function(){input.required=false;search();});}
