...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.df01e2d1924bd6edf5957fc920642aaab1504410e110a5ff727de1ca82030eeb.js',function(){input.required=false;search();});}
