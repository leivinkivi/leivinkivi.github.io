...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b5943999cd958a0bc012c9cf843c1b477aff6b0f750d2f34a6a7efebd6f2128f.js',function(){input.required=false;search();});}
