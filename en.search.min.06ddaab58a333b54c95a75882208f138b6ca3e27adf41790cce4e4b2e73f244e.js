...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ca207ded446e88bbbff11539e9a46db02052bdd00d20a1264626840aa8609fdb.js',function(){input.required=false;search();});}
