...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.43b92858fdb05180f608e0abd9473bf72d785cba3b6ffc4f413dfd5822ea61d3.js',function(){input.required=false;search();});}
