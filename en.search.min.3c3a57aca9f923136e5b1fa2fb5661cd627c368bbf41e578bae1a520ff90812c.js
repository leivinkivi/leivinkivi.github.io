...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.60503140b342ecb42a3b58699436c979166c3fe96eb6b31cc539c70b79f1d7c4.js',function(){input.required=false;search();});}
